...
def fill_form(page):
    ...
    try:
        ...
        page.fill('[name="namesurname"], [name="name"], [name="fullname"], [id="name"], [name="your-name"]', form_data["name"])
    except Exception:
    ...
    try:
        ...
        # Butonları tek tek kontrol et ve tıkla
    button_selectors = [
        '.contact-form__send-btn',  # SEND butonu
        '#formSend',  # Send Now butonu
        '[name="send"], [id="send"]'  # Diğer butonlar
    ]
    ...
    for selector in button_selectors:
        try:
            ...
            if button:
                ...
                break  # Bir buton tıklandıktan sonra döngüden çık
        except Exception:
            print(f"{selector} butonuna tıklanırken hata oluştu.")
