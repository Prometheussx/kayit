...
def create_lead(name="", phone="", email=""):
    url = "https://api.airtable.com/v0/app57DdSVqcybOscV/UniAktif"  # Change this to your Airtable API URL
    headers = {
...
def create_assistant(client):
    ...
    if os.path.exists(assistant_file_path):
        ...
        file = client.files.create(file=open("main.pdf", "rb"), purpose='assistants')
